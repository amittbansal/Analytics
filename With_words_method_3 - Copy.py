    ...
    def cal(self):
        ...
        with open(self.completeName5) as openfile:
            for line in openfile:
                ...
                m = m + 1
                selfoname = "repeated_words_topic.txt"    
        ...
        selfoname = "wordcloud.png"    
    	selfcompleteName7 = os.path.join(save_path2,selfoname) 
    	ro.r.assign('selfcompleteName7',selfcompleteName7)

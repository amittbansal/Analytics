    ...
    def cal(self):
        ...
        with open(self.completeName5) as openfile:
            for line in openfile:
                ...
                self.completeName6 = os.path.join(save_path1,selfoname)         
                k = k+1
                words = line.split()
                for word in words :
                    listabc.append(word)
                ...
                for i in range(0,length):
                    ...
                    ro.r.assign('self.completeName6',self.completeName6)
                    ro.r('sink(self.completeName6,append=TRUE)')
                ...
                ro.r.assign('self.completeName7',self.completeName7)
                ro.r('text <- readLines(self.completeName6)')
                ...
                ro.r('png(self.completeName7, width=1280,height=800)')
                ro.r('wordcloud(words = d$word, freq = d$freq, min.freq = 1, max.words=200, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))')     
                l = l+1
                del listabc[:]
                times = 5
